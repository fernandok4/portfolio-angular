        ...
        return {
            events: [
                ...
                },
                {
                    ...
                    description: "Um dos grandes momentos em que tive dentro da faculdade foi a noticia de que um caminhão cheio de tecnologia e que passou por grandes faculdades no Brasil também iria fazer uma pausa na FATEC Rubens Lara. A noticia maior ainda foi de que haveria uma imersão tecnologica dentro do caminhão de IoT, Watson AI e muito desenvolvimento iOS usando a linguagem Swift. Na mesma hora comecei a estudar para que pudesse ingressar nessa imersão, uma vez que foi selecionado por meio de mini cursos sobre alguns temas fundamentais para o ingresso. E com nota máxima nos 4 módulos desse mini-curso pude adentrar e viver um mês de imersão dentro do HackATruck! Foi uma experiencia incrivel de Networking e muito aprendizado.",
